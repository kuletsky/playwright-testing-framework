...
test.describe('Menu Why Empower functionality', () => {
    ...
    const whyEmpowerLinks = [
        { name: 'About us', menuHeading: "Learn how Empower is helping over 19.5 million people find financial freedom throughout all of life’s milestones with an experience unlike any other.", url: '/about-us', pageHeading: "We are Empower" },
