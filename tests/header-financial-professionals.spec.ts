...
test.describe('Solutions menu functionality', () => {
    ...
    const solutionsLinks = [
        ...
        { name: "Private market investments", menuHeading: "Private market investments", url: "/financial-professionals/what-we-offer/private-market-investments", pageHeading: "Helping to convert lifetime savings into a retirement income stream" },
